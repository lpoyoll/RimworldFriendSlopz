...
<p align="center">
  ...
  <img alt="Release" src="https://img.shields.io/badge/release-v0.1.24-d97738" />
...
v0.1.24 is the matched client/server release for live shared-tile play.
...
[Download Rimjob v0.1.24](https://github.com/lpoyoll/RimworldFriendSlopz/releases/tag/v0.1.24)

## Installation

Rimjob requires **Harmony**.

For Windows, use the [v0.1.24 MSI](https://github.com/lpoyoll/RimworldFriendSlopz/releases/download/v0.1.24/Rimjob-v0.1.24-x64.msi). It installs the client under the selected RimWorld installation at `Mods/Rimjob`; select the optional server component on the hosting PC.

Both clients and the server must use v0.1.24. `Update.exe` updates the client only, so the host must also replace or reinstall the server when moving between releases.
