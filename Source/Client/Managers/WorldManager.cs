...
{
    private static string TempWorldPath => Path.Combine(Master.AppdataTempPath, "World.temp");
...
public static class WorldManagerH
{
    ...
    {
        List<NPCFactionDetail> npcFactions = [];
    ...
    {
        List<NPCFactionDetail> planetFactions = [];
        ...
        foreach (Faction faction in existingFactions)
        {
            try
            {
                ...
                else
                {
                    ...
                    planetFaction.Color = [faction.Color.r, faction.Color.g, faction.Color.b, faction.Color.a];
    ...
    {
        List<FeatureDetail> planetFeatures = [];
        ...
        foreach (WorldFeature worldFeature in worldFeatures)
        {
            try
            {
                ...
                planetFeature.DrawCenter = [worldFeature.drawCenter.x, worldFeature.drawCenter.y, worldFeature.drawCenter.z
                ];
